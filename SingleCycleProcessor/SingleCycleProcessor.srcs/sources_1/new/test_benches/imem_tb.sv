...
module imem_tb();
	...
	logic [N-1:0] q;
	int errors = 0;
	parameter int tests = 50;

  logic [31:0] test_vector [0:49] = '{
            ...
            32'h8b1003de, 32'hf81f83d9, 32'hb400001f, 32'h0, 32'h0,
            32'h0
  };
  ...
  */
	...
	initial begin
		...
		$display("%d test(s) completed with %d error(s)", tests, errors);
		$stop;
	end
endmodule
